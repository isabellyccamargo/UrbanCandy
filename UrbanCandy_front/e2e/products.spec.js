...
test.describe('CRUD de Produtos (Painel Admin)', () => {
  ...
  test('Deve preencher o formulário e enviar um novo produto com upload de imagem', async ({
    page,
  }) => {
    ...
    await page
      .locator('label:has-text("Nome do Produto") + input')
      .fill('Bolo de Cenoura com Brigadeiro');
    await page
      .locator('label:has-text("Descrição Curta") + input')
      .fill('Delicioso bolo artesanal fofinho.');
