...
class UserRoleController {
    static async findAllUserRoles(
        ...
        try {
            ...
            const result =
                await UserRoleService.findAllUserRoles(
                    pageNumber,
                    sizeNumber
                );
    ...
    static async findByIdUserRole(
        ...
        try {
            ...
            const userRole =
                await UserRoleService.findByIdUserRole(id);
    ...
    static async findByUser(
        ...
        try {
            ...
            const userRoles =
                await UserRoleService.findByUser(id);
    ...
    static async findByRole(
        ...
        try {
            ...
            const userRoles =
                await UserRoleService.findByRole(id);
