...
class PermissionController {
  static async findAllPermissions(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const result = await PermissionService.findAllPermissions(pageNumber, sizeNumber);
  ...
  static async findByIdPermission(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const permission = await PermissionService.findByIdPermission(id);
